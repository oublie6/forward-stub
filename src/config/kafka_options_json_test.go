...
func TestSenderConfigKafkaOptionFieldsUnmarshal(t *testing.T) {
	var sc SenderConfig
	if err := json.Unmarshal([]byte(`{"type":"kafka","remote":"127.0.0.1:9092","topic":"out","dial_timeout":"11s","request_timeout":"31s","retry_timeout":"2m","retry_backoff":"300ms","conn_idle_timeout":"40s","metadata_max_age":"6m","partitioner":"hash_key","record_key_source":"match_key","compression_level":5}`), &sc); err != nil {
